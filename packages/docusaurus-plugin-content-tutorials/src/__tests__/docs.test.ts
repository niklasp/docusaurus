...
describe('versioned site', () => {
  ...
  it('versioned docs', async () => {
    ...
    await version100TestUtils.testMeta(path.join('hello.md'), {
      ...
      version: '1.0.0',
      source:
        '@site/i18n/en/docusaurus-plugin-content-tutorials/version-1.0.0/hello.md',
      tags: [],
    });
  ...
  it('translated fr doc with editUrl and editLocalizedFiles=true', async () => {
    ...
    await testUtilsLocal.testMeta(path.join('hello.md'), {
      ...
      version: '1.0.0',
      source:
        '@site/i18n/fr/docusaurus-plugin-content-tutorials/version-1.0.0/hello.md',
      editUrl:
        'https://github.com/facebook/docusaurus/edit/main/website/i18n/fr/docusaurus-plugin-content-tutorials/version-1.0.0/hello.md',
      tags: [],
    });
  });
  ...
  it('translated fr doc with editUrl and editLocalizedFiles=true + editCurrentVersion=true', async () => {
    ...
    await testUtilsLocal.testMeta(path.join('hello.md'), {
      ...
      source:
        '@site/i18n/fr/docusaurus-plugin-content-tutorials/version-1.0.0/hello.md',
      editUrl:
        'https://github.com/facebook/docusaurus/edit/main/website/i18n/fr/docusaurus-plugin-content-tutorials/current/hello.md',
      tags: [],
    });
  });
});
