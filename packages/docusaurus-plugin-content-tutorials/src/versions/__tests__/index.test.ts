    ...
    async function loadSite() {
      ...
      const vCurrent: VersionMetadata = {
        ...
        contentPathLocalized: path.join(
          simpleSiteDir,
          'i18n/en/docusaurus-plugin-content-tutorials/current',
        ),
        isLast: true,
        routePriority: -1,
  ...
  describe('versioned site, pluginId=default', () => {
    async function loadSite() {
      ...
      const v101: VersionMetadata = {
        ...
        contentPathLocalized: path.join(
          versionedSiteDir,
          'i18n/en/docusaurus-plugin-content-tutorials/version-1.0.1',
        ),
        isLast: true,
        routePriority: -1,
      ...
      const v100: VersionMetadata = {
        ...
        contentPathLocalized: path.join(
          versionedSiteDir,
          'i18n/en/docusaurus-plugin-content-tutorials/version-1.0.0',
        ),
        isLast: false,
        routePriority: undefined,
        sidebarFilePath: path.join(
      ...
      const vWithSlugs: VersionMetadata = {
        ...
        contentPathLocalized: path.join(
          versionedSiteDir,
          'i18n/en/docusaurus-plugin-content-tutorials/version-withSlugs',
        ),
        isLast: false,
        routePriority: undefined,
        sidebarFilePath: path.join(
      ...
      expect(versionsMetadata).toEqual([
        {
          ...
          editUrlLocalized:
            'https://github.com/facebook/docusaurus/edit/main/website/i18n/en/docusaurus-plugin-content-tutorials/current',
        },
        {
          ...v101,
          editUrl:
          ...
          editUrlLocalized:
            'https://github.com/facebook/docusaurus/edit/main/website/i18n/en/docusaurus-plugin-content-tutorials/version-1.0.1',
        },
        {
          ...v100,
          editUrl:
          ...
          editUrlLocalized:
            'https://github.com/facebook/docusaurus/edit/main/website/i18n/en/docusaurus-plugin-content-tutorials/version-1.0.0',
        },
        {
          ...vWithSlugs,
          editUrl:
          ...
          editUrlLocalized:
            'https://github.com/facebook/docusaurus/edit/main/website/i18n/en/docusaurus-plugin-content-tutorials/version-withSlugs',
        },
      ]);
    });
  ...
  describe('versioned site, pluginId=community', () => {
    async function loadSite() {
      ...
      const vCurrent: VersionMetadata = {
        ...
        contentPathLocalized: path.join(
          versionedSiteDir,
          'i18n/en/docusaurus-plugin-content-tutorials-community/current',
        ),
        isLast: false,
        routePriority: undefined,
        sidebarFilePath: path.join(versionedSiteDir, 'sidebars.json'),
      ...
      const v100: VersionMetadata = {
        ...
        contentPathLocalized: path.join(
          versionedSiteDir,
          'i18n/en/docusaurus-plugin-content-tutorials-community/version-1.0.0',
        ),
        isLast: true,
        routePriority: -1,
        sidebarFilePath: path.join(
